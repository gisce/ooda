                ...
                if node is not None:
                    ...
                    if pos == 'replace':
                        ...
                        for child in node2.getiterator('attribute'):
                            attribute = (child.get('name'), child.text
                                         and child.text.encode('utf8') or None)
                            if attribute[1]:
                    ...
                    raise AttributeError(_("View id: %s fails. Couldn't find tag '%s' in parent view !") % (view_id, tag))
            return src
